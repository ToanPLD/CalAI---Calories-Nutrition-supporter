# data/kaggle/ingest_exercise_activities.py
...
def run():
    print("🚀 ingest_exercise_activities (768 model)")
    ...
    COLLECTION = "exercise_vectors_768"
    ...
    print(f"\n🎯 DONE ingest_exercise_activities → {total} records")
