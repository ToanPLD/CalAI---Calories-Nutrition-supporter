# data/kaggle/ingest_global_food_10k.py
...
def run():
    print("🚀 ingest_global_food_10k (768 model)")

    dataset = "kanchana1990/global-food-nutrition-database10k-products"
    COLLECTION = "food_global_10k_vectors_768"
    DOMAIN = "food"
    ...
    print(f"\n🎯 DONE ingest_global_food_10k → {total} records")
