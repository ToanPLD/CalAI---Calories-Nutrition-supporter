# data/kaggle/ingest_diet_recommendations.py
...
def run():
    print("🚀 ingest_diet_recommendations (768 model)")
    ...
    COLLECTION = "diet_recommendations_vectors"
    ...
    print(f"\n🎯 DONE ingest_diet_recommendations → {total} records")
