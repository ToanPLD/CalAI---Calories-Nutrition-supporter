...
def load_dataframe(file_path):
    ...
    if file_path.endswith(".csv"):
        return pd.read_csv(
            ...
            encoding="utf-8",
            engine="python",
            on_bad_lines="warn"   # 🔥 giữ tối đa dữ liệu
        )
...
# =========================
def run():
    print("🚀 Start ingest nutrition CSV dataset...")
    ...
    for idx, row in df.iterrows():
        ...
        # dataset này nhiều field dinh dưỡng → check nhẹ
    ...
    print("✅ Done ingest nutrition CSV dataset")
