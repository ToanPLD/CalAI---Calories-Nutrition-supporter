# data/kaggle/ingest_gym_exercise.py
...
def run():
    print("🚀 ingest_gym_exercise (768 model)")

    dataset = "valakhorasani/gym-members-exercise-dataset"
    COLLECTION = "exercise_gym_vectors_768"
    DOMAIN = "exercise"
    ...
    for file in files:
        ...
        for _, row in df.iterrows():
            ...
            # =========================
            # CLEAN (dataset gym thường nhiều field text)
            # =========================
    ...
    print(f"\n🎯 DONE ingest_gym_exercise → {total} records")
