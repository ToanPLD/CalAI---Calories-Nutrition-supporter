# data/kaggle/ingest_starbucks.py
...
def run():
    print("🚀 ingest_starbucks (768 model)")

    dataset = "henryshan/starbucks"
    COLLECTION = "beverage_vectors_768"
    DOMAIN = "beverage"
    ...
    print(f"\n🎯 DONE ingest_starbucks → {total} records")
